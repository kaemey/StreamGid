                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3 text-start">
                                <label for="isStreamer"
                                    class="col-md-4 col-form-label text-md-end">{{ __(key: 'Я стример') }}</label>

                                <div class="col-md-6">
                                    <input type="checkbox" id="isStreamer" name="isStreamer"
                                        style="transform: scale(2); margin-top: 3%;" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text"
                                        ...
                                        value="{{ old('phone') }}" required autocomplete="phone" placeholder="+7">
